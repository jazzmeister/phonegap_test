...
var AppRouter = Backbone.Router.extend({
    ...
    changePage: function (page) {        
        ...
        //## NEEDS TO BE PASSED IN AS ARG AS THE CLICKED ELEMENT KNOWS WHICH WAY TO MOVE TO THE TARGET PAGE --- NOT THE TARGET PAGE ITSELF
        // e.g. previous button to go LEFT to prev question, next button to go RIGHT to next question (both are actually the same page)
